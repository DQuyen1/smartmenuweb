...
//       try {
//         const response = await axios.get(`https://3.1.81.96/api/Templates?templateId=${templateId}`);
...
//     try {
//       const response = await axios.put(`https://3.1.81.96/api/Templates/${updatedTemplateData.templateId}`, updatedTemplateData);
//       if (response.status === 200) {
//         // Update templateData in location state (optional, but recommended)
...
//             label="Width"
//             name="templateWidth"
//             value={updatedTemplateData.templateWidth}
//             onChange={handleChange}
//             fullWidth
//             sx={{ mt: 2 }}
//             select
...
//             label="Height"
//             name="templateHeight"
//             value={updatedTemplateData.templateHeight}
//             onChange={handleChange}
//             fullWidth
//             sx={{ mt: 2 }}
//             select
